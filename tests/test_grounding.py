...
def test_explanation_agent_evidence_grounding():
    ...
    # Mock AI response
    mock_ai = MagicMock()
    mock_ai.complete.return_value = "Verstappen had strong pace averaging 1:34.210 with moderate degradation."
    
    agent = ExplanationAgent(mock_ai)
    explanation = agent.explain("Tell me about VER's pace", tool_results, knowledge_results)
